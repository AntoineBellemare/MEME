...
Bundle of **Max4Live devices** using **EEG signal** for **dynamical audio-visual composition**. It is designed to provide <font color="red">flexible mapping of real-time EEG signals for digital artists</font>
